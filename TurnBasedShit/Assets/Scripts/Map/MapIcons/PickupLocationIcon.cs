...
public class PickupLocationIcon : MapIcon {
    float mBotOffset = -5.0f, mTopOffset = 15.0f;
    ...
    public override void mouseOver() {
        ...
        //  skull
        transform.GetChild(1).GetComponent<RectTransform>().DOScale(1.15f, enterSpeed);
        transform.GetChild(1).GetComponent<RectTransform>().DOLocalMoveY(transform.GetChild(1).GetComponent<RectTransform>().transform.localPosition.y + mBotOffset, enterSpeed);

        //  bones
        transform.GetChild(2).GetComponent<RectTransform>().DOScale(1.25f, enterSpeed);
        transform.GetChild(2).GetComponent<RectTransform>().DOLocalMoveY(transform.GetChild(2).GetComponent<RectTransform>().transform.localPosition.y + mTopOffset, enterSpeed);
    }

    public override void mouseExit() {
        isMouseOver = false;

        var preset = FindObjectOfType<MapLocationSpawner>().pickupLocationPreset.transform;
    ...
    public override IEnumerator idleAnim() {
        ...
        //  skull
        transform.GetChild(1).GetComponent<RectTransform>().DOScale(1.05f, speed);
        transform.GetChild(1).GetComponent<RectTransform>().DOLocalMoveY(transform.GetChild(1).GetComponent<RectTransform>().transform.localPosition.y + mBotOffset / 2.0f, speed);

        //  bones
        transform.GetChild(2).GetComponent<RectTransform>().DOScale(1.15f, speed);
        transform.GetChild(2).GetComponent<RectTransform>().DOLocalMoveY(transform.GetChild(2).GetComponent<RectTransform>().transform.localPosition.y + mTopOffset / 2.0f, speed);
