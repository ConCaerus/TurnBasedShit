...
public class SummonSpotSpawner : MonoBehaviour {
    ...
    public void updateSpots() {
        ...
        foreach(var i in spawnedSpots) {
            ...
            if(unit == null || unit.stats.equippedWeapon == null || unit.stats.equippedWeapon.isEmpty() || unit.stats.equippedWeapon.w_specialUsage != Weapon.specialUsage.summoning || i.transform.parent.childCount != unit.stats.getSummonedLevel())
                hideSpot(i.gameObject);
            else
